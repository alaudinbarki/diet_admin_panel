...
class AllCoursesWidget extends StatefulWidget {
  AllCoursesWidget({super.key, required this.title});
  var title;
  @override
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(
                  width: 248.webW(context),
                  child: const CategoryHeader(
                    title: 'Price ',
                    imagePath: null,
                  ).paddingOnly(left: 30.webT(context)),
                ),
                const CategoryHeader(
                  title: 'Upload Date',
                  imagePath: Images.iconFilter,
