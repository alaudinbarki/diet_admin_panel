              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      "Date range".toTextWeb(context: context, fontSize: 28, fontWeight: FontWeight.w600, color: blackPrimary),
                      "21 Nov 2022 - 29 Nov 2022".toTextWeb(context: context, fontSize: 22, color: containerTextColor),
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          "Total Weight Loss".toTextWeb(context: context, fontSize: 26, fontWeight: FontWeight.w500, color: blackPrimary),
                          Row(
                            children: [
                              Container(
                              ...
                              "All User".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary),
                              ...
                              12.webScaleWidth(context),
                              "Men".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary),
                              15.webScaleWidth(context),
                              Container(
                                width: 12.webT(context),
                                height: 12.webT(context),
                              ...
                              12.webScaleWidth(context),
                              "Women".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary),
                            ],
                          ),
                        ],
                      ),
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      "Chart criteria".toTextWeb(context: context, fontSize: 26, fontWeight: FontWeight.w500, color: blackPrimary),
                      12.webHeight(context),
                      "Gender".toTextWeb(context: context, fontSize: 20, fontWeight: FontWeight.w500, color: blackPrimary),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: "All User".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary).center,
                          ),
                          12.webWidth(context),
                          Container(
                            width: 80.webT(context),
                            ...
                            child: "Men".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary).center,
                          ),
                          12.webWidth(context),
                          Container(
                            width: 80.webT(context),
                            ...
                            child: "Women".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary).center,
                          ),
                        ],
                      ),
                      12.webHeight(context),
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(32.webT(context))
                                  ),
                                  child: (i + 1).toString().toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary).center,
                      ...
                      12.webHeight(context),
                      "Round".toTextWeb(context: context, fontSize: 20, fontWeight: FontWeight.w500, color: blackPrimary),
                      10.webHeight(context),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(6.webT(context))
                                  ),
                                  child: (i + 1).toString().toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: blackPrimary).center,
                                ).paddingOnly(right: 7.webW(context)),
                              ],
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      "Latest User Entries".toTextWeb(context: context, fontSize: 28, fontWeight: FontWeight.bold, color: blackPrimary).paddingSymmetric(vertical: 20.webT(context)),
                      Container(
                        ...
                        child: Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            "Export".toTextWeb(context: context, fontSize: 16, color: whitePrimary,),
                            5.webWidth(context),
                            CustomImage(image: Images.iconDropDown, width: 22.webT(context), height: 22.webT(context), iconColor: whitePrimary,),
                          ],
                        ).center,
                      ),
                    ],
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: SizedBox(
                          ...
                          ).paddingSymmetric(horizontal: 36.webT(context),),
                        ),
                      ),
                      SizedBox(
                        ...
                        child: Row(
                          children: [
                            "Name and surname".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w600, color: blackPrimary),
                      ...
                      SizedBox(
                        ...
                        child: "Day on the Plan".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w600, color: blackPrimary).center,
                      ),
                      SizedBox(
                        width: 265.webW(context),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            "Date of Entry".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w600, color: blackPrimary),
                            CustomImage(image: Images.iconFilter, width: 16.webT(context), height: 16.webT(context))
                          ],
                        ).center,
                      ),
                      SizedBox(
                        width: 265.webW(context),
                        child: "Weight Change".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w600, color: blackPrimary).center
                      ),
                      SizedBox(
                        width: 265.webW(context),
                        child: Row(
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    CustomImage(image: Images.iconDummyImage, width: 40.webT(context), height: 40.webT(context)),
                                    16.webWidth(context),
                                    "Poppie van Staden".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w400, color: blackPrimary),
                                  ],
                                ).center,
                              ),
                              SizedBox(
                                width: 265.webW(context),
                                child: "Day 1".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w400, color: blackPrimary).center,
                              ),
                              SizedBox(
                                width: 265.webW(context),
                                child: "18-Feb-19  05:49".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w400, color: blackPrimary).center,
                              ),
                              SizedBox(
                                width: 265.webW(context),
                                child: "+1.2 kg".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w400, color: blackPrimary).center,
                              ),
                              SizedBox(
                                width: 265.webW(context),
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      10.webWidth(context),
                                      index %2 == 0
                                          ? "Basic".toTextWeb(context: context, fontSize: 16, color: blackPrimary,)
                                          : "Active".toTextWeb(context: context, fontSize: 16, color: blackPrimary,),
                                    ],
                                  ).paddingSymmetric(horizontal: 12.webW(context), vertical: 5.webH(context)).center,
                                ).align(Alignment.center).paddingOnly(right: 30.webW(context)),
                              ),
                            ],
                          ).onPress(() {
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      "1 ".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: bluePrimary),
                                      "- 20 of 1 256".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: textGreyColor),
                                    ],
                                  ),
                                  Row(
                                    children: [
                                      "Entries per page".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: textGreyColor),
                                      15.webWidth(context),
                                      Container(
                                        width: 80.webT(context),
                                        ...
                                        child: Row(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            "25".toTextWeb(context: context, fontSize: 16, color: bluePrimary),
                                            6.webWidth(context),
                                            CustomImage(image: Images.iconDropDown, width: 24.webT(context), height: 24.webT(context), iconColor: bluePrimary,),
                                          ],
                                        ).center,
                                      ),
                                      Container(
                                      ...
                                      Container(
                                        ...
                                        child: Icon(Icons.arrow_back, color: greyLight, size: 24.webT(context),).center,
                                      ),
                                      "of 29".toTextWeb(context: context, fontSize: 16, fontWeight: FontWeight.w500, color: bluePrimary).paddingSymmetric(horizontal: 15.webT(context)),
                                      Container(
                                        width: 40.webT(context),
                                        height: 40.webT(context),
                                        decoration: BoxDecoration(
                                        ...
                                        child: Icon(Icons.arrow_forward, color: bluePrimary, size: 24.webT(context),).center,
                                      ),
                                    ],
                                  ),
                                ],
