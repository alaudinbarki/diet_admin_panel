...
import 'package:base_code/view/screens/receipe_screens/components/ingrediant_widget/widgets/detail_ingredents_egg_widget.dart';
...
class DetailIngrediantsScreen extends StatefulWidget {
  const DetailIngrediantsScreen({super.key});

  @override
  State<DetailIngrediantsScreen> createState() =>
      _DetailIngrediantsScreenState();
}
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const DetailIngredentsEggWidget(),
                ],
