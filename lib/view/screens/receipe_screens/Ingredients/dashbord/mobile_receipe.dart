...
class MobileIngrediantsScreen extends StatefulWidget {
  const MobileIngrediantsScreen({super.key});

  @override
  State<MobileIngrediantsScreen> createState() =>
      _MobileIngrediantsScreenState();
}

class _MobileIngrediantsScreenState extends State<MobileIngrediantsScreen> {
