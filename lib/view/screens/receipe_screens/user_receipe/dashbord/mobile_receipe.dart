...
class MobUserReceipeScreen extends StatefulWidget {
  const MobUserReceipeScreen({super.key});

  @override
  State<MobUserReceipeScreen> createState() => _MobUserReceipeScreenState();
}

class _MobUserReceipeScreenState extends State<MobUserReceipeScreen> {
